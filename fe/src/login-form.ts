    ...
    return html`<div class="bg-base-200 p-8 rounded shadow-md w-full sm:w-96">
      ...
      <form class="space-y-5">
        <label class="input flex items-center gap-2">
          ...
          <input type="text" id="username" name="username" class="grow" placeholder="Username" required />
        </label>
        <div class="indicator w-full">
          <span class="indicator-item badge badge-primary">optional</span>
          <label class="input flex items-center gap-2 w-full">
            ...
            <input type="text" id="session" name="session" class="grow" placeholder="Session ID" />
          </label>
        </div>
